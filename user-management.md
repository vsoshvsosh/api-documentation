...
Ruphish поддерживает наличие нескольких учетных записей пользователей. Каждая из этих учетных записей отдельная, со своими собственными кампаниями, целевыми страницами, шаблонами и т.д.

Каждой учетной записи пользователя в Ruphish назначается **роль**. Это глобальные роли, которые описывают разрешения пользователя в Ruphish.
...
| Администратор | `admin` | Роль административного пользователя. Пользователи с этой ролью могут управлять общесистемными настройками, а также другими учетными записями пользователей в Ruphish. |
...
Возвращает список всех учетных записей пользователей в Ruphish.
