...
"Профиль отправки" - это конфигурация SMTP, которая указывает Ruphish, как отправлять электронные письма.
...
Кроме того, многие развертывания SMTP-серверов используют самоподписанные сертификаты. Чтобы указать Ruphish игнорировать эти недействительные сертификаты, установите поле `ignore_cert_errors` в значение `true`.
